...
HD_PWD='C:/Users/user/Desktop/Everyhting/College/4th_Year/FYP/RISC-V-FYP/RISCV_Top/vhdl/xilinxprj/RISC-V.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log singleCycCompTop.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source singleCycCompTop.tcl -notrace
