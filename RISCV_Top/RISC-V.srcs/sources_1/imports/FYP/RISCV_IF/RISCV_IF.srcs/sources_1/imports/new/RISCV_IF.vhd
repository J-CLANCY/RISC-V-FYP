...
current_pc_Assign: pc        <= pc_internal2;                                 -- Current program counter assignment
next_pc_Assign:    pc_plus_4 <= std_logic_vector(unsigned(pc_internal2) + 1); -- Next sequential program counter value assignment. NB CHANGE TO +4 LATER
