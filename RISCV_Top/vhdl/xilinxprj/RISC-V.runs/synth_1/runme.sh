...
HD_PWD='C:/Users/user/Desktop/Everyhting/College/4th_Year/FYP/RISC-V-FYP/RISCV_Top/vhdl/xilinxprj/RISC-V.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log singleCycCompTop.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source singleCycCompTop.tcl
